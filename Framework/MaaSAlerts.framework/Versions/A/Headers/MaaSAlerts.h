...
/**
 ...
 @param error An NSError object that encapsulates information why registration did not succeed. The application can display this information to the user.
 */
...
/**
 ...
 @param pushID The remote notification push ID. The pushID can be found in the `application:didReceiveRemoteNotification:` userInfo, `[userInfo objectForKey:@"pid"].
 */
...
/**
 ...
 @param groupIDs An array of 1 or more `NSString` objects that represent the group IDs that are being subscribed to.
